document.addEventListener('DOMContentLoaded', () => {
  ...
  const translations = {
    es: {
      ...
      "tag-tech": "Tecnología",
      "tag-pos": "Punto de Venta",
      "tag-safety": "Seguridad Industrial",
      "tag-data": "Ciencia de Datos",
      "btn-visit": "Visitar Sitio",
      "btn-sheet": "Ficha Técnica",
      "btn-presentation": "Presentación",
      "btn-more-projects": "Ver más proyectos",
      "more-projects-title": "¿Quieres explorar más proyectos y código?",
      ...
      "support-card2-desc": "Planificación, cableado estructurado, configuración de redes locales e instalación de sistemas de seguridad y CCTV.",
      "support-card2-f1": "Instalación de cableado estructurado UTP",
      "support-card2-f2": "Configuración de Routers, Switches y APs",
      "support-card2-f3": "Instalación y configuración de cámaras de seguridad (CCTV / IP)",
      "support-card2-f4": "Seguridad, segmentación (VLANs) y monitoreo remoto",
      ...
      "exp-date-0": "Febrero 2026 - Actualidad",
      "exp-role-0": "Desarrollador Web",
      "exp-task-0-1": "Desarrollo de sitios y aplicaciones web a medida para distintos clientes, adaptándome a sus necesidades y objetivos.",
      "exp-task-0-2": "Gestión autónoma de proyectos, desde la planificación y cotización hasta la entrega final.",
      "exp-task-0-3": "Comunicación directa con clientes para definir requerimientos y mantenerlos informados de los avances.",
      "exp-date-1": "Abril 2025 - Diciembre 2025",
      "exp-role-1": "Emprendedor",
      "exp-task-1-1": "Gestión de compras nacionales e internacionales, evaluando proveedores y asegurando entregas eficientes.",
      "exp-task-1-2": "Coordinación de inventarios y seguimiento de mercancía local e importada.",
      "exp-task-1-3": "Apoyo a otros negocios en la realización de sus importaciones y procesos logísticos.",
      ...
      "exp-date-4": "Diciembre 2022 - Abril 2023",
      "exp-role-4": "Asistente de Compras",
      "exp-task-4-1": "Realicé análisis de rendimiento de proveedores y evaluación de metas de abastecimiento, ajustando estrategias de compra y selección de proveedores para optimizar costos y resultados.",
      "exp-task-4-2": "Coordiné la gestión de inventarios mediante la solicitud, seguimiento y verificación de mercancía, asegurando la disponibilidad de productos clave y manteniendo un flujo de stock eficiente.",
      "exp-date-5": "Junio 2022 - Diciembre 2022",
      "exp-role-5": "Agente de Ventas",
      "exp-task-5-1": "Gestioné ventas directas, brindando asesoría detallada a cada cliente y ayudándolos a elegir productos según sus necesidades.",
      "exp-task-5-2": "Realicé inventarios periódicos y optimicé la disposición de productos, mejorando la organización y accesibilidad en el espacio de ventas.",
    ...
    en: {
      ...
      "tag-tech": "Technology",
      "tag-pos": "POS System",
      "tag-safety": "Industrial Safety",
      "tag-data": "Data Science",
      "btn-visit": "Visit Site",
      "btn-sheet": "Technical Sheet",
      "btn-presentation": "Presentation",
      "btn-more-projects": "View more projects",
      "more-projects-title": "Want to explore more projects & code?",
      ...
      "support-card2-desc": "Planning, cabling, local network configuration, and installation of security systems and CCTV.",
      "support-card2-f1": "Installation of UTP structured cabling",
      "support-card2-f2": "Configuration of Routers, Switches, and APs",
      "support-card2-f3": "Installation and configuration of security cameras (CCTV / IP)",
      "support-card2-f4": "Security, segmentation (VLANs), and remote monitoring",
      ...
      "exp-date-0": "February 2026 - Present",
      "exp-role-0": "Web Developer",
      "exp-task-0-1": "Development of custom websites and web applications for various clients, tailored to their needs and goals.",
      "exp-task-0-2": "Autonomous project management, from planning and quoting to final delivery.",
      "exp-task-0-3": "Direct communication with clients to define requirements and keep them updated on progress.",
      "exp-date-1": "April 2025 - December 2025",
      "exp-role-1": "Entrepreneur",
      "exp-task-1-1": "National and international purchasing management, evaluating suppliers and ensuring efficient delivery.",
      "exp-task-1-2": "Inventory coordination and tracking of local and imported merchandise.",
      "exp-task-1-3": "Support to other businesses in handling their import and logistics processes.",
      ...
      "exp-date-4": "December 2022 - April 2023",
      "exp-role-4": "Purchasing Assistant",
      "exp-task-4-1": "Performed supplier performance analysis and supply target evaluations, adjusting purchasing strategies and supplier selection to optimize costs and results.",
      "exp-task-4-2": "Coordinated inventory management through requesting, tracking, and verifying merchandise, ensuring key product availability and maintaining efficient stock flow.",
      "exp-date-5": "June 2022 - December 2022",
      "exp-role-5": "Sales Agent",
      "exp-task-5-1": "Managed direct sales, providing detailed advice to each client and helping them select products according to their needs.",
      "exp-task-5-2": "Conducted periodic inventories and optimized product displays, improving organization and accessibility within the sales floor.",
